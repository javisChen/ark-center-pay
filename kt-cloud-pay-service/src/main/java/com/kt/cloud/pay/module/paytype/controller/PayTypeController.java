package com.kt.cloud.pay.module.paytype.controller;
...
import com.kt.cloud.pay.module.paytype.service.PayTypeService;
...
public class PayTypeController extends BaseController {
    ...
    @ApiOperation(value = "查询支付类别表分页列表")
    @PostMapping("/page")
